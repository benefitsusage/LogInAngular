...
@Component({
  selector: 'app-model-popup-king-green',
  templateUrl: './model-popup-king-green.component.html',
  styleUrls: ['./model-popup-king-green.component.scss']
})
export class ModelPopupKingGreenComponent implements OnInit {

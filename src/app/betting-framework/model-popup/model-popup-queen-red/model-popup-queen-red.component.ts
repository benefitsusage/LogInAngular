...
@Component({
  selector: 'app-model-popup-queen-red',
  templateUrl: './model-popup-queen-red.component.html',
  styleUrls: ['./model-popup-queen-red.component.scss']
})
export class ModelPopupQueenRedComponent implements OnInit {

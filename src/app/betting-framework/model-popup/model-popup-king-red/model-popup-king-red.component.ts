...
@Component({
  selector: 'app-model-popup-king-red',
  templateUrl: './model-popup-king-red.component.html',
  styleUrls: ['./model-popup-king-red.component.scss']
})
export class ModelPopupKingRedComponent implements OnInit {

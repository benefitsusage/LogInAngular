...
@Component({
  selector: 'app-model-popup-queen-green',
  templateUrl: './model-popup-queen-green.component.html',
  styleUrls: ['./model-popup-queen-green.component.scss']
})
export class ModelPopupQueenGreenComponent implements OnInit {

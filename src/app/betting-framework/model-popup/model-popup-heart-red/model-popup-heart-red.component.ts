...
@Component({
  selector: 'app-model-popup-heart-red',
  templateUrl: './model-popup-heart-red.component.html',
  styleUrls: ['./model-popup-heart-red.component.scss']
})
export class ModelPopupHeartRedComponent implements OnInit {

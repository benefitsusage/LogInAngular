...
@Component({
  selector: 'app-model-popup-heart-green',
  templateUrl: './model-popup-heart-green.component.html',
  styleUrls: ['./model-popup-heart-green.component.scss']
})
export class ModelPopupHeartGreenComponent implements OnInit {

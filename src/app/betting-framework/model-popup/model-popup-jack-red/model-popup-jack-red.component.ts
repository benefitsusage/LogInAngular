...
@Component({
  selector: 'app-model-popup-jack-red',
  templateUrl: './model-popup-jack-red.component.html',
  styleUrls: ['./model-popup-jack-red.component.scss']
})
export class ModelPopupJackRedComponent implements OnInit {
